...
$resultD=mysql_query("select DinlenmeSayisi from farklimuzik where SarkiAdi='$sarkid' and SarkiciAdi='$sarkicid'");
$resultD=mysql_fetch_row($resultD);

$resultD[0]=$resultD[0]+1;

$resultP=mysql_query("select SarkiPuan from farklimuzik where SarkiAdi='$sarkid' and SarkiciAdi='$sarkicid'");
$resultP=mysql_fetch_row($resultP);
$resultP[0]=$resultP[0]+$selected;
$ort=$resultP[0]/$resultD[0];

mysql_query("update farklimuzik set DinlenmeSayisi='$resultD[0]', SarkiOrt='$ort', SarkiPuan='$resultP[0]' where SarkiAdi='$sarkid' 
