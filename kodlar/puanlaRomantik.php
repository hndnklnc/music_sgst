...
mysql_query("update romantik set DinlenmeSayisi='$resultD[0]', SarkiOrt='$ort', SarkiPuan='$resultP[0]' where SarkiAdi='$sarkid' 
and SarkiciAdi='$sarkicid'" ) ;
...
print "<form id='form3' name='form3' method='post' action=puanlaRomantik.php>
