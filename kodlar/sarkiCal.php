...
if($i==0){
$sarkiLink=htmlspecialchars($_POST['sarkiYeri']);
$sarkiAd=htmlspecialchars($_POST['sarkiAdi']);
$sarkiciAd=htmlspecialchars($_POST['sarkiciAdi']);
...
print "</th>"."</table>";
print "<form id='form3' name='form3' method='post' action=puanla.php>
